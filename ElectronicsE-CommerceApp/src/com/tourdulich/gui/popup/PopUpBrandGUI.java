...
public class PopUpBrandGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTenDichVu.setText("Tên Nhãn Hiệu");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpBrandGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpBrandGUI().setVisible(true);
            }
        });
    }
