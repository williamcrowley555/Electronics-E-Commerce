...
public class PopUpCatalogGUI extends javax.swing.JFrame {
    ...
    public boolean validateForm() 
    {
        ...
        if (InputValidatorUtil.isValidName(txtCatalogName.getText(), true).isEmpty())  
        {
            tenDichVu = true;
            ...
            lblTenDichVu.setToolTipText(InputValidatorUtil.isValidName(txtCatalogName.getText(), true));
        } 
    ...
    private void initComponents() {
        ...
        txtCatalogName = new javax.swing.JTextField();
        ...
        lblTenDichVu.setText("Tên Loại:");

        txtCatalogName.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txtCatalogName.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(204, 204, 204)));
        ...
        pnlBodyLayout.setVerticalGroup(
            ...
            .addGroup(pnlBodyLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtCatalogName, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(39, 39, 39)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpCatalogGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpCatalogGUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtCatalogName;
