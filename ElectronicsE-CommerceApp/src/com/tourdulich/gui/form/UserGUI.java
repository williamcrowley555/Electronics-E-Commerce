...
import com.tourdulich.gui.popup.PopUpTableNhanVienGUI;
import com.tourdulich.gui.popup.PopUpUserGUI;
...
public class UserGUI extends javax.swing.JPanel {
    ...
    private void tblUserMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUserMouseReleased
        // TODO add your handling code here:
        int r = tblUser.rowAtPoint(evt.getPoint());
        if (r >= 0 && r < tblUser.getRowCount()) {
            tblUser.setRowSelectionInterval(r, r);
        } else {
