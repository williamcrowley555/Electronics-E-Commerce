 ...
 * @author RavenPC
 */
public class CatalogGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblCatalog.setFillsViewportHeight(true);
        tblCatalog.setIntercellSpacing(new java.awt.Dimension(0, 0));
        tblCatalog.setRowHeight(35);
        tblCatalog.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tblCatalogMouseReleased(evt);
            }
        });
        scroll.setViewportView(tblCatalog);
    ...
    private void btnThemMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThemMousePressed
        if (this.popUp == null) {
            this.popUp = new PopUpCatalogGUI("POST");
    ...
    private void tblCatalogMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCatalogMouseReleased
        // TODO add your handling code here:
        int r = tblCatalog.rowAtPoint(evt.getPoint());
        if (r >= 0 && r < tblCatalog.getRowCount()) {
            tblCatalog.setRowSelectionInterval(r, r);
        } else {
           tblCatalog.clearSelection();
        }
    ...
    }//GEN-LAST:event_tblCatalogMouseReleased
