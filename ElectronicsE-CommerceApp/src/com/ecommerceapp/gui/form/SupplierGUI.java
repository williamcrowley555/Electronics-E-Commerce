...
import com.ecommerceapp.gui.popup.PopUpSupplierGUI;
import com.ecommerceapp.gui.popup.PopUpUserGUI;
import com.ecommerceapp.util.SupplierTableLoaderUtil;
...
public class SupplierGUI extends javax.swing.JPanel {
    ...
    private PopUpSupplierGUI popUp = null;
    ...
    public void loadTableData() {
        tblSupplier.setModel(new SupplierTableLoaderUtil().setTable(supplierBLL.findAll(), this.listColumns)) ;
        this.rowSorter = TableSetupUtil.setTableFilter(tblSupplier, txtTimKiem);
        resizeColumnWidth(tblSupplier);
        headerColor(77,77,77,tblSupplier);
    }
    ...
    private void initComponents() {
        ...
        pnlHeadLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlHeadLayout.createSequentialGroup()
                ...
                .addGroup(pnlHeadLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnThem, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tblSupplier.setIntercellSpacing(new java.awt.Dimension(0, 0));
        ...
        scroll.setViewportView(tblSupplier);
    ...
    private void btnThemMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThemMousePressed
        if (this.popUp == null) {
            this.popUp = new PopUpSupplierGUI("POST");
        } else {
            this.popUp.toFront();
            this.popUp.center();
        }
    ...
    private void itemSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemSuaActionPerformed
        ...
        Long id = Long.parseLong(tblSupplier.getValueAt(rowindex,0).toString());
        if (this.popUp == null) {
        popUp = new PopUpSupplierGUI("PUT", supplierBLL.findById(id));
        } else {
            this.popUp.toFront();
            this.popUp.center();
        }
    ...
    private void tblSupplierMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSupplierMouseReleased
        // TODO add your handling code here:
        int r = tblSupplier.rowAtPoint(evt.getPoint());
        if (r >= 0 && r < tblSupplier.getRowCount()) {
            tblSupplier.setRowSelectionInterval(r, r);
        } else {
