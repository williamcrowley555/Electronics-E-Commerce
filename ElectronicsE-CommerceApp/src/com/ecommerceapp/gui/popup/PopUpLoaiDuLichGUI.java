 ...
 * @author Hi
 */
public class PopUpLoaiDuLichGUI extends javax.swing.JFrame {
    private String action;
    private ILoaiDuLichBLL loaiDuLichBLL;
    private LoaiDuLichDTO loaiDuLich;
   
    public PopUpLoaiDuLichGUI(String action) {
        initComponents();      
        this.action = action;
    ...
    public PopUpLoaiDuLichGUI(String action, LoaiDuLichDTO  loaiDuLich) {
        initComponents();
        this.action = action;
        this.loaiDuLich = loaiDuLich;
        loaiDuLichBLL = new LoaiDuLichBLL();
        CustomWindow();
        setLabelText(loaiDuLich);
        this.setVisible(true);
    }
    
    public void setLabelText(LoaiDuLichDTO loaiDuLich)
    {
        txtTenLoaiDuLich.setText(loaiDuLich.getTenLoaiDuLich());
    }
    
    private LoaiDuLichDTO getFormInfo() {
        LoaiDuLichDTO loaiDuLich = new LoaiDuLichDTO();
        if(this.loaiDuLich != null) {
            loaiDuLich.setId(this.loaiDuLich.getId());
        }
        loaiDuLich.setTenLoaiDuLich(txtTenLoaiDuLich.getText().trim());
        return loaiDuLich;
    }
 
    public PopUpLoaiDuLichGUI() {
        initComponents();
        CustomWindow();
    }
    ...
    public boolean validateForm() 
    {
       ...
       if(InputValidatorUtil.isValidName(txtTenLoaiDuLich.getText(), true).isEmpty())
       {
           lblValidateTenLoaiDuLich.setIcon(iconCheck);
           lblValidateTenLoaiDuLich.setToolTipText(null);
           return true;
       }
       else {
           lblValidateTenLoaiDuLich.setIcon(iconError);
           lblValidateTenLoaiDuLich.setToolTipText(InputValidatorUtil.isValidName(txtTenLoaiDuLich.getText(), true));
          return false;
       }
    }
    public void center()
    ...
    private void initComponents() {
        ...
        txtTenLoaiDuLich = new javax.swing.JTextField();
        btnLuu = new javax.swing.JButton();
        btnHuy = new javax.swing.JButton();
        lblValidateTenLoaiDuLich = new javax.swing.JLabel();
        ...
        lblTenVaiTro.setText("Tên Loại Du Lịch");
        lblTenVaiTro.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N

        txtTenLoaiDuLich.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(204, 204, 204)));
        txtTenLoaiDuLich.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
            ...
            .addGroup(pnlBodyLayout.createSequentialGroup()
                ...
                .addGroup(pnlBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlBodyLayout.createSequentialGroup()
                        ...
                        .addComponent(lblValidateTenLoaiDuLich, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(txtTenLoaiDuLich, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        pnlBodyLayout.setVerticalGroup(
            ...
            .addGroup(pnlBodyLayout.createSequentialGroup()
                ...
                .addGroup(pnlBodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lblTenVaiTro)
                    .addComponent(lblValidateTenLoaiDuLich, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addComponent(txtTenLoaiDuLich, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        if (validateForm())
        {    
            LoaiDuLichDTO loaiDuLich = getFormInfo();

            if(this.action.equals("POST")) {             
                    Long newLoaiDuLichId = loaiDuLichBLL.save(loaiDuLich);
                    if(newLoaiDuLichId != null) {
                    ...
                    try {
                        loaiDuLichBLL.update(loaiDuLich);
                        JOptionPane.showMessageDialog(this, "Lưu thành công!!!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                        dispose();
                    } catch(Exception e) {
                        JOptionPane.showMessageDialog(this, "Lưu thất bại!!!", "Thông báo", JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUpLoaiDuLichGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpLoaiDuLichGUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblValidateTenLoaiDuLich;
    private javax.swing.JPanel panelHeader;
    private javax.swing.JPanel pnlBody;
    private javax.swing.JTextField txtTenLoaiDuLich;
