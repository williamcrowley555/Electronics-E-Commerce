...
public class MenuItem extends javax.swing.JPanel {
    ImageIcon iconMinus = new ImageIcon(getClass().getResource("/com/ecommerceapp/img/minus_icon.png"));
    ImageIcon iconPlus = new ImageIcon(getClass().getResource("/com/ecommerceapp/img/plus_icon.png"));
    Boolean flag = false;
    ...
    public MenuItem(Icon icon, String menuName, ActionListener act, MenuItem... subMenu) {
       ...
       // Line.setBorder(BorderFactory.createMatteBorder(0,1,1,1, Color.BLACK)); 
        ...
        for (int i = 0; i < subMenu.length; i++) {
            ...
            subMenu[i].setBorder(BorderFactory.createEmptyBorder(0, 30, 0, 0));
        }
    }
